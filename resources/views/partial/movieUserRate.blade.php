...
<form id="rateForm" class="align-top" style="display: inline-flex;" action="/rate/rate" method="post">
    <div class="rating-group">
        ...
        <input class="rating__input rating__input--none" name="rating" id="rating-0" value="0" type="radio" {{ checkValue(0, $model->Note()) }}>
        ...
        <input class="rating__input" name="rating" id="rating-05" value="0.5" type="radio" {{ checkValue(0.5, $model->Note()) }}>
        <label aria-label="1 star" class="rating__label" for="rating-10"><i class="rating__icon rating__icon--star fa fa-star"></i></label>
        <input class="rating__input" name="rating" id="rating-10" value="1" type="radio" {{ checkValue(1, $model->Note()) }}>
        ...
        <input class="rating__input" name="rating" id="rating-15" value="1.5" type="radio" {{ checkValue(1.5, $model->Note()) }}>
        ...
        <input class="rating__input" name="rating" id="rating-35" value="3.5" type="radio" {{ checkValue(3.5, $model->Note()) }}>
        <label aria-label="4 stars" class="rating__label" for="rating-40"><i class="rating__icon rating__icon--star fa fa-star"></i></label>
        <input class="rating__input" name="rating" id="rating-40" value="4" type="radio" {{ checkValue(4, $model->Note()) }}>
        ...
        <input class="rating__input" name="rating" id="rating-45" value="4.5" type="radio" {{ checkValue(4.5, $model->Note()) }}>
        <label aria-label="5 stars" class="rating__label" for="rating-50"><i class="rating__icon rating__icon--star fa fa-star"></i></label>
        <input class="rating__input" name="rating" id="rating-50" value="5" type="radio" {{ checkValue(5, $model->Note()) }}>
    </div>
</form>
